...
public class ArticleService {
    ...
    public List<Article> selectArticlePage(Integer pageNum, Integer pageSize, String title, Integer articleTypeId) {
        Integer index = (pageNum - 1) * pageSize;
        return this.articleMapper.selectArticlePage(index, pageSize, title, articleTypeId);
    }

    // 根据id查询一篇文章
    public Article selectOneById(Integer id) {
        return this.articleMapper.selectOneById(id);
    }
